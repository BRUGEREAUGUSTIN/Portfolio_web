...
<nav id="header-navbar" class="navbar navbar-expand-lg py-4">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center text-white" href="index.php">
            <h3 class="font-weight-bolder mb-0">AUGUSTIN BRUGERE</h3>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbar-nav-header">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="about.php">Ma formation</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="MesProjets.php">Mes projets</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="blog.php">Mes compétences</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="loisirs.php">Mes loisirs</a>
                </li>
                <li class="nav-item">
...
<div id="side-nav" class="sidenav">
    ...
    <div class="sidenav-content">
        <p>
            42 cours Richard Vitton, Lyon 69003, France
        </p>
        <p>
            <span class="fs-16 primary-color">(+33) 0782904396</span>
        </p>
