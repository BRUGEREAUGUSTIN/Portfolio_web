...
<div class="jumbotron d-flex align-items-center">
    <div class="container text-center">
        <h1 class="display-1 mb-4">PORT<br>FOLIOS test</h1>
    </div>
    ...
    <div class="triangle triangle-1">
        <img src="../../public/img/obj_triangle.png" alt="">
    </div>
...
<?php /*<section id="features" class="bg-white">
    <div class="container">
        <div class="section-content">
            ...
            <div class="title-wrap mb-5" data-aos="fade-up">
                ...
                <p class="section-sub-title">Praesent commodo cursus magna, vel scelerisque nisl consectetur et. <br>
                    pharetra augue. Donec id elit non mi.</p>
            </div>
                ...
                <div class="col-md-12">
                    <div class="row align-items-center text-white">
                        ...
                        <div class="col-md-4 offset-md-2 col-sm-6" data-aos="fade-right">
                            ...
                            <p>Nulla vitae elit libero, a pharetra augue. Maecenas sed diam eget risus varius blandit
                                sit amet non magna. Cras mattis consectetur purus sit amet.</p>
                        ...
                        <div class="col-md-4 offset-md-right-2 col-sm-6" data-aos="flip-right">
                            <img class="my-5" src="../../public/img/app-profile-mockup.png" alt="">
                ...
                <div class="col-md-12">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-4 offset-md-2 col-sm-6" data-aos="flip-left">
                            <img class="my-5" src="../../public/img/augustin_profil.jpg" alt="">
                        </div><!--/ .col-md-4.col-md-offset-right-2.col-sm-6 -->

                        <div class="col-md-4 offset-md-right-2 col-sm-6" data-aos="fade-left">
                            <h4 class="mb-4">Qui suis-je?</h4>
                            <p>Je m’appelle Augustin et j’ai 20 ans. <br>
                                Je suis actuellement en 2ième année de BTS SIO (services informatiques aux
                                organisations) option SLAM (Développement d’applications) à l’ORT de Lyon.
                                <br>
                                Attiré par l’informatique et les nouvelles technologies depuis mes jeunes années, je me
                                suis reconvertis dans le domaine en vue d’intégrer une école de cybersécurité.
                                <br>
                                Diplômé du BAC SCIENTIFIQUE avec mention (Spécialité Math-Physique).</p>
                            <?php /* <div class="progress mb-3">
                                <div class="progress-bar" role="progressbar" style="width: 95%;" aria-valuenow="95"
                                     aria-valuemin="0" aria-valuemax="100">HTML5 95%
                                </div>
                            </div>
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" style="width: 90%;" aria-valuenow="90"
                                     aria-valuemin="0" aria-valuemax="100">CSS3 90%
                                </div>
                            </div> */ ?>
                        </div><!--/ .col-md-4.col-md-offset-2.col-sm-6 -->
...
<!-- Testimonial Section-->
<?php /*<section id="testimonial" class="section-padding bg-fixed bg-white overlay"
         style="background-image: url(../../public/img/bg-white.jpg);">
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="testi-content testi-carousel owl-carousel">
                    <div class="testi-item text-center">
                        ...
                        <h4 class="testi-text"><b>ROXY</b> is best theme i used so far.<br> It’s ideal for guys without
                            coding knowledge like me!</h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="../../public/img/testi-1.jpg" alt="">
                            </div>
                    ...
                    <div class="testi-item text-center">
                        <i class="testi-icon fa fa-3x fa-quote-left"></i>
                        <h4 class="testi-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci <br>
                            non doloribus ut, alias doloremque perspiciatis.</h4>
                        <div class="testi-meta-inner d-flex justify-content-center align-items-center">
                            <div class="testi-img mr-2">
                                <img src="../../public/img/testi-1.jpg" alt="">
                            </div>
...
<!-- End of Testimonial Section-->
   <!-- Portfolio Section -->
<?php /*<section id="portfolio" class="bg-white">
    <div class="container">
        <div class="section-content">
            <!-- Section Title -->
                    ...
                    <div class="grid-portfolio">
                        ...
                        <div class="grid-item minimalism" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../../public/img/photo-1.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        <a class="img-pop" data-rel="lightcase" href="../../public/img/photo-1.jpg"
                                           title="Photo-1">
                        ...
                        <div class="grid-item vintage" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../../public/img/photo-6.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        <a class="img-pop" data-rel="lightcase" href="../../public/img/photo-6.jpg"
                                           title="Ship">
                                            <span class="lnr lnr-move"></span>
                                        </a>
                                        <a class="ext-link" href="https://unsplash.com/" target="_blank">
                        ...
                        <div class="grid-item creative grid-item-height" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../../public/img/photo-2.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        <a class="img-pop" data-rel="lightcase" href="../../public/img/photo-2.jpg"
                        ...
                        <div class="grid-item creative" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../../public/img/photo-7.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        <a class="img-pop" data-rel="lightcase" href="../../public/img/photo-7.jpg"
                                           title="Guitar">
                                            <span class="lnr lnr-move"></span>
                                        </a>
                                        <a class="ext-link" href="https://unsplash.com/" target="_blank">
                        ...
                        <div class="grid-item vintage" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../../public/img/photo-4.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        <a class="img-pop" data-rel="lightcase" href="../../public/img/photo-4.jpg"
                                           title="Bookself">
                                            <span class="lnr lnr-move"></span>
                                        </a>
                                        <a class="ext-link" href="https://unsplash.com/" target="_blank">
                        ...
                        <div class="grid-item creative" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../../public/img/photo-9.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                                        <a class="img-pop" data-rel="lightcase" href="../../public/img/photo-9.jpg"
                                           title="Guitar">
                                            <span class="lnr lnr-move"></span>
                                        </a>
                                        <a class="ext-link" href="https://unsplash.com/" target="_blank">
...
<!-- End of Portfolio Section -->
   <!-- Client Section -->
<?php /*<section id="client" class="overlay bg-fixed" style="background-image: url(../../public/img/bg.jpg);">
    <div class="container">
        <div class="section-content" data-aos="fade-up">
            <div class="row ">
                <div class="col-md-12">
                ...
                <div class="col-md-12 client-holder">
                    <div class="client-slider owl-carousel">
                        <div class="client-item">
                            <img class="img-responsive" src="../../public/img/client.png" alt=" ">
                        </div>
                        <div class="client-item">
                            <img class="img-responsive" src="../../public/img/client.png" alt=" ">
                        </div>
...
<!-- End of Client Section -->
     <!-- Reservation Section -->
<?php /*<section id="reservation" class="bg-white section-content">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 offset-lg-1" data-aos="fade-left">
                ...
                <p class="mb-4">I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet,
...
<?php /*<section id="cta" class="bg-fixed overlay" style="background-image: url(../../public/img/bg.jpg);">
    <div class="container">
        <div class="section-content" data-aos="fade-up">
            <div class="row">
                <div class="col-md-12 text-center">
